...
func DefaultRuleset() Ruleset {
	return Ruleset{
		...
		AchievementThresholds: AchievementThresholds{
			SuccessfulSellerMinPublished:    1,
			SuccessfulSellerMinSaleRate:     0.70,
			ConsistentPublisherMinPublished: 10,
			ConsistentPublisherMinSaleRate:  0.50,
		...
		AchievementPolicy: AchievementPolicy{
			...
			Rules: []AchievementRuleConfig{
				...
				{Code: model.AchievementDecisiveStep, Category: model.AchievementCategoryInterest, Priority: 70},
			},
		},
		...
		SharePolicy: SharePolicy{
			...
			AllowedAchievementCodes: []model.AchievementCode{
				...
				model.AchievementQuickDecision, model.AchievementStyleIcon,
				model.AchievementFashionableMan, model.AchievementTraveler,
				model.AchievementForTheSoul, model.AchievementBookworm,
				model.AchievementBeautyConnoisseur, model.AchievementInTheRhythmOfMusic,
				model.AchievementWorldOfPlay, model.AchievementMasterCraft,
				model.AchievementCaringOwner, model.AchievementLittleDiscoveries,
