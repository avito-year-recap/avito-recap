...
func Build(metrics model.Metrics) []model.Achievement {
	return BuildWithRuleset(ruleset.DefaultRuleset(), metrics)
}
...
func BuildWithRuleset(r ruleset.Ruleset, metrics model.Metrics) []model.Achievement {
